  ...
  return {
    shared: {
      ...
      announcements: [
        {
          id: uid(),
          title: 'Controleer je ID of paspoort',
          text: 'Neem op de dag van vertrek een geldig identiteitsbewijs mee. Zonder ID kun je niet mee op reis.',
          type: 'urgent',
          link: ''
        }
      ],
      instagramLinks: [
        {
          id: uid(),
          title: 'DevelsteinCollege Instagram',
          url: 'https://www.instagram.com/develsteincollegezwijndrecht/'
        }
      ]
    },
    groups: {
      A: {
        ...
        leiding: 'Mevr. Jansen, Dhr. Bakker',
        program: [
          {
            id: uid(), dayShort: 'Ma', dayLabel: 'Dag 1',
            title: 'Vertrek, aankomst Parijs, Arc de Triomphe en bootreis',
            items: [
          ...
          },
          {
            ...
            items: [{ title: 'Hele dag — Disney', text: 'Een volledige dag in Disneyland Paris.' }]
          },
          {
      ...
      B: {
        ...
        leiding: 'Mevr. De Vries, Dhr. Smit',
        program: [
          {
            id: uid(), dayShort: 'Ma', dayLabel: 'Dag 1',
            title: 'Vertrek, aankomst Parijs, Arc de Triomphe en bootreis',
          ...
          {
            id: uid(), dayShort: 'Di', dayLabel: 'Dag 2', title: 'Disneyland Paris',
            items: [{ title: 'Hele dag — Disney', text: 'Volledige dag Disneyland Paris.' }]
          },
          {
            id: uid(), dayShort: 'Wo', dayLabel: 'Dag 3', title: 'Louvre, Eiffeltoren en vrije tijd',
            items: [
